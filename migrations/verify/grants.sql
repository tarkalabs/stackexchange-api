...
DO $$
    BEGIN
        ...
        ASSERT(SELECT 1 FROM information_schema.usage_privileges WHERE grantee='user_reg' AND object_name='posts_id_seq'), 'User_anon was not granted usage of sequence posts_id_seq.';
